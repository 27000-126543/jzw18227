...
const gitApi: GitApi = {
  ...
  push: (repoPath, remote, branch, setUpstream, forcePush) => ipcRenderer.invoke('git:push', repoPath, remote, branch, setUpstream, forcePush),
  getRemotes: (repoPath) => ipcRenderer.invoke('git:getRemotes', repoPath),
  getTags: (repoPath) => ipcRenderer.invoke('git:getTags', repoPath),
  getRangeDiff: (repoPath, fromRef, toRef) => ipcRenderer.invoke('git:getRangeDiff', repoPath, fromRef, toRef),
  fetch: (repoPath, remote, prune) => ipcRenderer.invoke('git:fetch', repoPath, remote, prune),
  fetchAll: (repoPath, prune) => ipcRenderer.invoke('git:fetchAll', repoPath, prune),
  remotePrune: (repoPath, remote) => ipcRenderer.invoke('git:remotePrune', repoPath, remote),
